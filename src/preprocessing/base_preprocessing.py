...
# Instalar skrub si no está disponible
try:
    from skrub import TextEncoder, SquashingScaler
except ImportError:
    import subprocess
    import sys
    print("Instalando skrub...")
    subprocess.check_call([sys.executable, "-m", "pip", "install", "-q", "skrub>=0.3.0"])
    from skrub import TextEncoder, SquashingScaler
    print("skrub instalado correctamente")
